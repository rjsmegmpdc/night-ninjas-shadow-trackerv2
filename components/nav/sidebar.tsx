...
export function Sidebar() {
  ...
  return (
    <aside className="w-56 border-r border-ink-line bg-ink h-screen sticky top-0 flex flex-col">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                'border-l-2',
                active
                  ? 'bg-ink-shadow border-accent text-bone'
      ...
      <div className="px-5 py-4 border-t border-ink-line space-y-3">
